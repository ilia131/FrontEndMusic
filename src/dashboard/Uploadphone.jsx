...
const Uploadphone = () => {
 ...
 const handleImageChange = (e) => {
  ...
  return (
    ...
    <div className='grid gap-4 p-4 bg-gradient-to-b from-yellow-900/80 via-background to-background'>
               ...
               <div  style={{ border: '1px dashed black', padding: '5px'}} className='text-right text-green-400 '>
                  ...
                  style={{
                   ...
                   accept='image/*' className='flex text-sm'/>
                      <div className='w-[100px] h-[100px] flex items-center justify-center text-[50px]'>
               ...
               <div className='text-center
                ...
                flex items-center justify-center
                 mt-2 rounded-md py-3
                  '>
                     {isLoading ? <Spinner sm /> : <button  onClick={handleUpload} className={Style.text}>آپلود</button> }
